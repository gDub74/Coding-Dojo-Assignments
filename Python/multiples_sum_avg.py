...
for int in range (1,1001): #for loop to run through the intigers from 1 to 1000
    if int % 2 == 1:  #conditional using the modulus opperator to check if the remainder is 1 == true
        print int
